...
public class LDAWapper {
	...
	public native static void JNI_Train(String dir, String model_name, String niters, String savestep, String twords, String input_file);
	public static void Train(String dir, String model_name, int iter_num, int save_step, int top_words, String input_file) {
		JNI_Train(dir, model_name, String.valueOf(iter_num), String.valueOf(save_step), String.valueOf(top_words), input_file);
	}
